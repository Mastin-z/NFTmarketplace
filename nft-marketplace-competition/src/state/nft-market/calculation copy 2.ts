...
// const { getNFTCount,getTransactionCount} = useNFTMarket();
...
const DataToStore = {
  ...
  export const UpgradesData = async (formValues: CreationValues1) => {
    ...
    DataToStore.wash_sales_usd=parseFloat(formValues.wash_sales_usd);
    console.log('Form wash_sales_usd111 from CreationForm1:', DataToStore.wash_sales_usd);
    DataToStore.wash_transactions=parseFloat(formValues.wash_transactions);
    console.log('Form wash_transactions222 from CreationForm1:', DataToStore.wash_transactions);
    DataToStore.wash_sales_percentage=parseFloat(formValues.wash_sales_percentage);
    console.log('Form wash_sales_percentage333 from CreationForm1:', DataToStore.wash_sales_percentage);
    DataToStore.trade_profit_usd=parseFloat(formValues.trade_profit_usd);
    console.log('Form trade_profit_usd444 from CreationForm1:', DataToStore.trade_profit_usd);
